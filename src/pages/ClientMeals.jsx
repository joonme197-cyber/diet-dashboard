...
export default function ClientMeals() {
  ...
  const loadDayData = async () => {
    ...
    try {
      // جلب المنيو اليومي
      const dayKey = getCycleDayKey(selectedClient.startDate || selectedDate, selectedDate);
  ...
  const dayKey = selectedClient?.startDate
    ? getCycleDayKey(selectedClient.startDate, selectedDate)
    : null;
