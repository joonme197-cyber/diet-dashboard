...
import {
  ...
  calcRecipeCost, calcFoodCostPct, bulkAddRecipes,
...
export default function RecipesPage() {
  ...
  const handleTemplate = () => {
    downloadSampleFile(
      ['اسم الوصفة', 'سعر البيع', 'المكونات', 'ملاحظات'],
      { 'اسم الوصفة': 'دجاج مشوي', 'سعر البيع': 2.500, 'المكونات': 'دجاج:0.250:1.750|أرز:0.100:0.500|زيت:0.020:1.000', 'ملاحظات': 'صيغة المكونات: اسم:كمية:تكلفة | اسم:كمية:تكلفة' },
  ...
  const handleImport = async (e) => {
    ...
    try {
      ...
      const count = await bulkAddRecipes(rows);
      setMsg(`تم استيراد ${count} وصفة`);
      load();
    ...
    <div>
      <div className="page-header">
        ...
        <div style={{ display:'flex', gap:8, flexWrap:'wrap' }}>
          ...
          <button className="btn btn-ghost" onClick={() => exportToPDF('rec-print', 'تقرير الوصفات')}>📄 PDF</button>
