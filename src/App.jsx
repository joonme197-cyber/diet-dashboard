...
const PopupCouponConfig  = lazy(() => import('./pages/PopupCouponConfig'));
...
const FinanceBreakdown   = lazy(() => import('./pages/FinanceBreakdown'));
const MealRecipesPage    = lazy(() => import('./pages/MealRecipesPage'));
      ...
      <main className="main-content">
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route path="/popup-coupon"      element={<ProtectedRoute perm="reports.financial"><PopupCouponConfig /></ProtectedRoute>} />
            ...
            <Route path="/finance/breakdown" element={<ProtectedRoute perm="reports.financial"><FinanceBreakdown /></ProtectedRoute>} />
            <Route path="/meal-recipes"      element={<ProtectedRoute perm="reports.financial"><MealRecipesPage /></ProtectedRoute>} />
            <Route path="/production"        element={<ProtectedRoute perm="reports.financial"><ProductionPage /></ProtectedRoute>} />
            <Route path="/cost-analysis"     element={<ProtectedRoute perm="reports.financial"><CostAnalysisPage /></ProtectedRoute>} />
            <Route path="/procurement-planning" element={<ProtectedRoute perm="reports.financial"><ProcurementPlanningPage /></ProtectedRoute>} />
            <Route path="/profit-loss"       element={<ProtectedRoute perm="reports.financial"><ProfitLossPage /></ProtectedRoute>} />
